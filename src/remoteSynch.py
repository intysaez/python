...
#After establishment of the files in between in the FS(File System)
class remoteSync(loadConfig):
    ...
    def __init__(self):
        ...
        self._sftp = False
#connection require host and username that was provided by config File 
...
#after making the connection secure file transfer protocol
